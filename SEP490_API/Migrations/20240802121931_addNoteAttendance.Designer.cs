...
namespace SEP490_API.Migrations
{
    ...
    [Migration("20240802121931_addNoteAttendance")]
    partial class addNoteAttendance
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BusinessObject.Entities.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = "GV0001",
                            IsActive = true,
                            Password = "$2a$11$n1dXo8SDj0lnG9MwkgKUf.psklVDXKvdImy8k9kWd1iA379ocGWx6",
                            RefreshToken = "",
                            RefreshTokenExpires = new DateTime(2024, 8, 2, 19, 19, 30, 362, DateTimeKind.Local).AddTicks(6213),
                            UserID = new Guid("61fc4a82-780f-4d08-b8e5-1dd689389f04"),
                            Username = "Admin"
                        },
                        new
                        {
                            ID = "GV0002",
                            IsActive = true,
                            Password = "$2a$11$r4edqoWROCJoBBy/QNRHoeq0YRLtmE.nnaSbg3WU9FTj.uWuMhD0C",
                            RefreshToken = "",
                            RefreshTokenExpires = new DateTime(2024, 8, 2, 19, 19, 30, 536, DateTimeKind.Local).AddTicks(1153),
                            UserID = new Guid("f9467e6e-2f3f-42bf-beb3-d7ba769ccb35"),
                        ...
                        new
                        {
                            ID = "GV0003",
                            IsActive = true,
                            Password = "$2a$11$f55DtYePYTzz7GKSI5we1.PMY0ZEyTbgfjUTrR/pxGesCqyjwILSK",
                            RefreshToken = "",
                            RefreshTokenExpires = new DateTime(2024, 8, 2, 19, 19, 30, 713, DateTimeKind.Local).AddTicks(130),
                            UserID = new Guid("200f2bec-8ab1-4df8-9039-e6b9daabea44"),
                        ...
                        new
                        {
                            ID = "GV0004",
                            IsActive = true,
                            Password = "$2a$11$0cuIBHpNebr26e/MV97LpeH3Z1bCk1lKNJ3VTZqr9g3ezlMhEgjtS",
                            RefreshToken = "",
                            RefreshTokenExpires = new DateTime(2024, 8, 2, 19, 19, 30, 950, DateTimeKind.Local).AddTicks(6372),
                            UserID = new Guid("1660aa15-6732-436d-91da-1af70cb5cf27"),
                            Username = "Supervisor"
                        });
                });
            ...
            modelBuilder.Entity("BusinessObject.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = new Guid("61fc4a82-780f-4d08-b8e5-1dd689389f04"),
                            Address = "600 Nguyễn Văn Cừ",
                            Avatar = "https://cantho.fpt.edu.vn/Data/Sites/1/media/logo-moi.png",
                            Birthday = new DateTime(2024, 8, 2, 19, 19, 30, 190, DateTimeKind.Local).AddTicks(1955),
                        ...
                        new
                        {
                            ID = new Guid("f9467e6e-2f3f-42bf-beb3-d7ba769ccb35"),
                            Address = "600 Nguyễn Văn Cừ",
                            Avatar = "https://cantho.fpt.edu.vn/Data/Sites/1/media/logo-moi.png",
                            Birthday = new DateTime(2024, 8, 2, 19, 19, 30, 362, DateTimeKind.Local).AddTicks(6448),
                            Email = "admin@fpt.edu.vn",
                            Fullname = "Lê Văn Admin",
                            Gender = "Nam",
                            IsBachelor = false,
                        ...
                        new
                        {
                            ID = new Guid("200f2bec-8ab1-4df8-9039-e6b9daabea44"),
                            Address = "600 Nguyễn Văn Cừ",
                            Avatar = "https://cantho.fpt.edu.vn/Data/Sites/1/media/logo-moi.png",
                            Birthday = new DateTime(2024, 8, 2, 19, 19, 30, 536, DateTimeKind.Local).AddTicks(1391),
                            Email = "admin@fpt.edu.vn",
                            Fullname = "Lê Văn Admin",
                            Gender = "Nam",
                            IsBachelor = false,
                        ...
                        new
                        {
                            ID = new Guid("1660aa15-6732-436d-91da-1af70cb5cf27"),
                            Address = "600 Nguyễn Văn Cừ",
                            Avatar = "https://cantho.fpt.edu.vn/Data/Sites/1/media/logo-moi.png",
                            Birthday = new DateTime(2024, 8, 2, 19, 19, 30, 713, DateTimeKind.Local).AddTicks(427),
                            Email = "admin@fpt.edu.vn",
                            Fullname = "Lê Văn Admin",
                            Gender = "Nam",
                            IsBachelor = false,
